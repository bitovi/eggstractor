---
name: maintain-css-transformer
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the CSS transformer without breaking utility class output or CSS custom property generation.
---
