---
name: maintain-shadow-processor
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the shadow processor without breaking drop-shadow and inner-shadow extraction from Figma effect nodes.
---
