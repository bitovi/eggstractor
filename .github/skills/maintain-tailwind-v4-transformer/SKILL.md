---
name: maintain-tailwind-v4-transformer
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the Tailwind v4 transformer without breaking @layer utility output or the @apply ordering contract.
---
