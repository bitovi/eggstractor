---
name: maintain-tailwind-v3-transformer
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the Tailwind v3 transformer without breaking the generator system, dynamic theme token map, or @apply-based utility class
---
