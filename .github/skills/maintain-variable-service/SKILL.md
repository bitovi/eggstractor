---
name: maintain-variable-service
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the variable service without breaking primitive and semantic variable token collection.
---
