---
name: maintain-effect-service
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the effect service without breaking effect style token collection.
---
