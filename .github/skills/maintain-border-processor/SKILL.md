---
name: maintain-border-processor
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the border processor without breaking border, outline, and inside-stroke-to-box-shadow extraction from Figma nodes.
---
