---
name: maintain-spacing-processor
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the spacing processor without breaking padding extraction and shorthand collapsing logic.
---
