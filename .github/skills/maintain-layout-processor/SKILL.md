---
name: maintain-layout-processor
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the layout processor without breaking flexbox, sizing, and border-radius extraction from Figma layout nodes.
---
