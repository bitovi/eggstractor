---
name: maintain-font-processor
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the font processor without breaking typography extraction from Figma TEXT nodes.
---
