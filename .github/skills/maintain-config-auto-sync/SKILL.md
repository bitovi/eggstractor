---
name: maintain-config-auto-sync
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the config auto-sync behavior without breaking the every-change save contract.
---
