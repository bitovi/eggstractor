---
name: maintain-variable-binding-resolution
description: Provides an agent with the knowledge needed to safely modify, debug, or extend variable binding resolution without breaking the alias-to-token lookup pipeline.
---
