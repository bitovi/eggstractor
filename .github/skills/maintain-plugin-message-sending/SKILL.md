---
name: maintain-plugin-message-sending
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the plugin message sending utility without breaking type safety or the Figma/dev-mode environment split.
---

# Skill: MaintainPluginMessageSending

## Purpose

Provides an agent with the knowledge needed to safely modify, debug, or extend the plugin message sending utility without breaking type safety or the Figma/dev-mode environment split.
