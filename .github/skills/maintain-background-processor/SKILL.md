---
name: maintain-background-processor
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the background processor without breaking color and opacity extraction from Figma nodes.
---
