---
name: maintain-naming-context
description: Provides an agent with the knowledge needed to safely modify, debug, or extend the naming context system without breaking name generation, deduplication, or delimiter configuration across output forma
---
