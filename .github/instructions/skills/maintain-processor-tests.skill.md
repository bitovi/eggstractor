...
Provides an agent with the knowledge needed to safely add, modify, or debug processor and transformer tests without breaking fixture conventions, snapshot strategy, or mock Figma environment setup.
