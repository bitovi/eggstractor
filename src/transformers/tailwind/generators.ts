...
*/
export const generateTailwindFontFamilyOutput: Generator = ({ rawValue }, dynamicTheme?: any) => {
...
type Generator = (token: GeneratorToken, dynamicTheme?: any) => string;

const createTailwindClassGenerators = (dynamicTheme?: any): Record<string, Generator> => ({
